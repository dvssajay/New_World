...
class ANDHRA(nn.Module):
  def __init__(self,in_planes):
    ...
    self.Relu2 = nn.PReLU(num_parameters=in_planes)
...
class AB_2GR3_100_PRel(nn.Module):
    
  def __init__(self, num_classes):
    super(AB_2GR3_100_PRel,self).__init__()
    ...
    self.Act21 = ANDHRA(in_planes = 128)
    self.Act22 = ANDHRA(in_planes = 128)
    ...
    self.Act31 = ANDHRA(in_planes = 256)
    self.Act32 = ANDHRA(in_planes = 256)
    self.Act33 = ANDHRA(in_planes = 256)
    self.Act34 = ANDHRA(in_planes = 256)
...
def ab_2GR3_100_PRel():
    net = AB_2GR3_100_PRel(100)
    return net
